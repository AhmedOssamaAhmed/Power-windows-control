...
__Vectors       DCD     __initial_sp              ; Top of Stack
                ...
                DCD     falling_handler             ;   0: GPIO Port A
                DCD     rising_handler             ;   1: GPIO Port B
                DCD     GPIOC_Handler             ;   2: GPIO Port C
                DCD     GPIOD_Handler             ;   3: GPIO Port D
                DCD     switch_handler             ;   4: GPIO Port E
...
falling_handler\
                PROC
                EXPORT  falling_handler [WEAK]
                B       .
                ENDP

rising_handler\
                PROC
                EXPORT  rising_handler [WEAK]
                B       .
                ENDP
